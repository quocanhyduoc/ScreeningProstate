        ...
        <header className="bg-white border-b border-slate-200 p-8 sticky top-0 z-[60] backdrop-blur-md bg-white/80">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
             <div className="flex items-center gap-6">
                <button onClick={() => router.back()} className="p-3 bg-slate-100 hover:bg-slate-200 rounded-lg transition-all text-slate-500"><ArrowLeft size={24}/></button>
                <div>
             ...
             <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center border border-blue-100 shadow-sm shadow-blue-50"><Activity size={24}/></div>
             </div>
          </div>
        </header>

        <div className="max-w-6xl mx-auto p-8 pt-12">
          <div className="bg-white border border-slate-200 rounded-xl p-6 mb-12 flex items-center gap-6 shadow-sm">
             <div className="w-14 h-14 bg-orange-50 text-orange-500 rounded-lg flex items-center justify-center flex-shrink-0"><Info size={28}/></div>
             <div>
          ...
          <SurveyForm 
            ...
            onComplete={() => router.push('/admin/dashboard?tab=clinical_screening')} 
          />
        </div>
      </main>
