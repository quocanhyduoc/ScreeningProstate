  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-2.5">
          <label className="text-[15px] font-black text-blue-900 ml-1 uppercase tracking-tight flex items-center gap-2">
            <User size={18} className="text-blue-600" /> Họ và tên <span className="text-red-500">*</span>
          </label>
          <input
            {...register('full_name', { required: 'Không được để trống' })}
            className="w-full px-5 py-4 bg-gray-50 border-2 border-gray-100 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-all font-black text-[18px] text-blue-900 shadow-sm"
        ...
        <div className="space-y-2.5">
          <label className="text-[15px] font-black text-blue-900 ml-1 uppercase tracking-tight flex items-center gap-2">
            <Calendar size={18} className="text-blue-600" /> Ngày sinh <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
        ...
        <div className="space-y-2.5">
          <label className="text-[15px] font-black text-blue-900 ml-1 uppercase tracking-tight flex items-center gap-2">
            <Fingerprint size={18} className="text-blue-600" /> Số CCCD <span className="text-red-500">*</span>
          </label>
          <input
        ...
        <div className="space-y-2.5">
          <label className="text-[15px] font-black text-blue-900 ml-1 uppercase tracking-tight flex items-center gap-2">
            <Phone size={18} className="text-blue-600" /> Số điện thoại <span className="text-red-500">*</span>
          </label>
          <input
        ...
        <div className="md:col-span-2 space-y-2.5">
          <label className="text-[15px] font-black text-blue-900 ml-1 uppercase tracking-tight flex items-center gap-2">
            <Mail size={18} className="text-blue-600" /> Email (Không bắt buộc)
          </label>
          <input
            {...register('email')}
            className="w-full px-5 py-4 bg-gray-50 border-2 border-gray-100 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-all font-black text-[18px] text-blue-900 shadow-sm"
      ...
      <div className="pt-8 border-t-2 border-gray-100">
        <h3 className="text-[18px] font-black text-blue-900 mb-6 flex items-center gap-3">
          <MapPin size={22} className="text-blue-600" /> ĐỊA CHỈ LIÊN LẠC
        </h3>
        <div className="grid md:grid-cols-2 gap-6">
          <SearchableSelect
          ...
          <div className="space-y-2.5">
            <label className="text-[15px] font-black text-blue-900 ml-1 uppercase tracking-tight">Số nhà, tên đường <span className="text-red-500">*</span></label>
            <input
      ...
      {!isEligible() && watch('dob') && (
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="mt-6 p-8 bg-red-50 rounded-2xl border-2 border-red-100 flex items-center gap-6 shadow-lg shadow-red-50">
          <AlertCircle className="text-red-500 shrink-0" size={40} />
          <p className="text-red-900 font-black text-[16px] leading-tight">
      ...
      <div className="flex gap-4 pt-4">
        ...
        <button
          type="button"
          onClick={handleNext}
          className="flex-1 py-5 bg-blue-600 text-white rounded-xl font-black text-xl hover:bg-blue-700 transition-all flex items-center justify-center gap-3 shadow-2xl shadow-blue-200 active:scale-[0.98]"
        >
